            ...
            <div class="row">
                    ...
                    <div class="card gradient-1">
                        <div class="card-body">
                            ...
                            <div class="d-inline-block">
                                <h2 class="text-white" style="font-size: 1.8rem">23,400,000</h2>
                ...
                <div class="col-lg-3 col-sm-6" style="padding-left: 10px; padding-right: 10px;">
                    <div class="card gradient-2">
                        <div class="card-body">
                            <h3 class="card-title text-white">연도별매출</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white" style="font-size: 1.8rem">123,130,000</h2>
                                <p class="text-white mb-0">21년 06월 01일</p>
                            </div>
                ...
                <div class="col-lg-3 col-sm-6" style="padding-left: 10px; padding-right: 10px;">
                    <div class="card gradient-3">
                        <div class="card-body">
                            ...
                            <div class="d-inline-block">
                                <h2 class="text-white" style="font-size: 1.8rem">94,000,000</h2>
                                <p class="text-white mb-0">21년 06월 01일</p>
                            </div>
                ...
                <div class="col-lg-3 col-sm-6" style="padding-left: 10px; padding-right: 10px;">
                    <div class="card gradient-4">
                        <div class="card-body">
                            <h3 class="card-title text-white">금일 출력현황</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white" style="font-size: 1.8rem">5명</h2>
                                <p class="text-white mb-0">21년 06월 01일</p>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body pb-0 d-flex justify-content-between">
                                    <div>
                                        <h4 class="mb-1">일별 매출 현황</h4>
                                        <p>Sales Status</p>
                                        <!--                                        <h4 class="card-title">시간대별 매출금액</h4>-->
                                        <h3 class="m-0"> ￦ 405,300</h3>
                                    </div>
<!--                                    <div>-->
<!--                                        <ul>-->
<!--                                            <li class="d-inline-block mr-3"><a class="text-dark" href="#day">Day</a>-->
<!--                                            </li>-->
<!--                                        </ul>-->
<!--                                    </div>-->
                                </div>
                                <div class="chart-wrapper">
                                    <div id="day" class="chart_widget_2">
                                        <!-- Chart code -->
                                        <script>
                                ...
                                <!--                                                <div
                                class="progress-bar bg-danger" style="width: 40%"></div>-- >
                                < !--
                                </div>-->
                                <!--                                        </div>-->
                                ...
                                <!--                                            <div class="progress" style="height: 6px">-->
                                <!--                                                <div
                                class="progress-bar bg-primary" style="width: 80%"></div>-- >
                                < !--
                                </div>-->
                                <!--                                        </div>-->
                                <!--                                    </div>-->
